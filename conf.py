...
BLOG_AUTHOR = "johanna hemminger"  # (translatable)
BLOG_TITLE = "johanna 周汉娜"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://exvolved.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://exvolved.com/"
BLOG_EMAIL = "exvolved@gmail.com"
BLOG_DESCRIPTION = "johanna's digital space."  # (translatable)
